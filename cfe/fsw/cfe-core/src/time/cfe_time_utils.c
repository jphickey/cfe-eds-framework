...
void CFE_TIME_InitData(void)
{
    ...
    */
    CFE_SB_InitMsg(&CFE_TIME_TaskData.HkPacket,
                    CFE_SB_MsgId_From_TopicId(CFE_MISSION_TIME_HK_TLM_TOPICID),
    ...
    */
    CFE_SB_InitMsg(&CFE_TIME_TaskData.DiagPacket,
                    CFE_SB_MsgId_From_TopicId(CFE_MISSION_TIME_DIAG_TLM_TOPICID),
    ...
    */
    CFE_SB_InitMsg(&CFE_TIME_TaskData.ToneSignalCmd,
                    CFE_SB_MsgId_From_TopicId(CFE_MISSION_TIME_TONE_CMD_TOPICID),
    ...
    */
    ...
    CFE_SB_InitMsg(&CFE_TIME_TaskData.ToneDataCmd,
                    CFE_SB_MsgId_From_TopicId(CFE_MISSION_TIME_DATA_CMD_TOPICID),
    ...
    */
    ...
    CFE_SB_InitMsg(&CFE_TIME_TaskData.ToneSendCmd,
                    CFE_SB_MsgId_From_TopicId(CFE_MISSION_TIME_SEND_CMD_TOPICID),
    ...
    */
    CFE_SB_InitMsg(&CFE_TIME_TaskData.Local1HzCmd,
                    CFE_SB_MsgId_From_TopicId(CFE_MISSION_TIME_ONEHZ_CMD_TOPICID),
...
void CFE_TIME_GetHkData(const CFE_TIME_Reference_t *Reference)
{
    ...
    */
    #if (CFE_PLATFORM_TIME_CFG_SERVER == true)
    CFE_TIME_Copy(&CFE_TIME_TaskData.HkPacket.Payload.AdjustmentDelay, &CFE_TIME_TaskData.OneHzAdjust);
    #endif
    ...
    */
    ...
    CFE_TIME_Copy(&CFE_TIME_TaskData.HkPacket.Payload.AdjustmentDelay, &Reference->AtToneDelay);
    #endif
