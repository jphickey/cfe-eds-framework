...
/* The TIME EDS is generated by the build scripts */
...
*/
int32 CFE_TIME_HousekeepingCmd(const CFE_TIME_SendHkCommand_t *data);

/*
** Command handler for "tone signal detected"...
*/
int32 CFE_TIME_ToneSignalCmd(const CFE_TIME_ToneSignalCommand_t *data);
...
*/
int32 CFE_TIME_OneHzCmd(const CFE_TIME_OneHzCommand_t *data);
...
int32 CFE_TIME_ToneSendCmd(const CFE_TIME_ToneSendCommand_t *data);
#endif
...
static const CFE_TIME_Application_Component_Telecommand_DispatchTable_t CFE_TIME_TC_DISPATCH_TABLE =
{
        .CMD =
        {
                .Add1HZAdjustmentCmd_indication = CFE_TIME_Add1HZAdjustmentCmd,
                .AddAdjustCmd_indication = CFE_TIME_AddAdjustCmd,
                .AddDelayCmd_indication = CFE_TIME_AddDelayCmd,
                .SendDiagnosticTlm_indication = CFE_TIME_SendDiagnosticTlm,
                .Noop_indication = CFE_TIME_NoopCmd,
                .ResetCounters_indication = CFE_TIME_ResetCountersCmd,
        ...
        .SEND_HK =
        {
                .indication = CFE_TIME_HousekeepingCmd
        },
        .ONEHZ_CMD =
        {
...
int32 CFE_TIME_TaskInit(void)
{
    ...
    CFE_SB_EDS_RegisterSelf(&CFE_TIME_DATATYPE_DB);
...
void CFE_TIME_TaskPipe(CFE_SB_MsgPtr_t MessagePtr)
{
    ...
    CmdStatus = CFE_TIME_Application_Component_Telecommand_Dispatch(
            CFE_SB_Telecommand_indication_Command_ID, MessagePtr, &CFE_TIME_TC_DISPATCH_TABLE);
    ...
    if (CmdStatus == CFE_STATUS_BAD_COMMAND_CODE)
    {
        ...
        CFE_EVS_SendEvent(CFE_TIME_CC_ERR_EID, CFE_EVS_EventType_ERROR,
                 "Invalid command code -- ID = 0x%X, CC = %u",
                          ...
                          (unsigned int)CFE_SB_GetCmdCode(MessagePtr));
    }
...
void CFE_TIME_1HzAdjImpl(const CFE_TIME_OneHzAdjustmentCmd_Payload_t *CommandPtr, CFE_TIME_AdjustDirection_Enum_t Direction)
{
    ...
    */
    ...
    CFE_TIME_Copy(&Adjust, &CommandPtr->Amount);
    ...
    CFE_EVS_SendEvent(CFE_TIME_1HZ_EID, CFE_EVS_EventType_INFORMATION,
       "STCF 1Hz Adjust -- secs = %d, ssecs = 0x%X, dir[1=Pos, 2=Neg] = %d",
                      (int)CommandPtr->Amount.Seconds, (unsigned int)CommandPtr->Amount.Subseconds, (int)Direction);
