...
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.Noop_indication)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_CMD_RESET_COUNTERS_CC =
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.ResetCounters_indication)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_CMD_SEND_DIAGNOSTIC_TLM_CC =
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.SendDiagnosticTlm_indication)
};
...
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.SetSourceCmd_indication)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_CMD_SET_SIGNAL_CC =
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.SetSignalCmd_indication)
};
...
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.SetLeapSecondsCmd_indication)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_CMD_ADD_ADJUST_CC =
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.AddAdjustCmd_indication)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_CMD_SUB_ADJUST_CC =
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.SubAdjustCmd_indication)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_CMD_ADD_1HZ_ADJUSTMENT_CC =
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.Add1HZAdjustmentCmd_indication)
};
static const UT_TaskPipeDispatchId_t UT_TPID_CFE_TIME_CMD_SUB_1HZ_ADJUSTMENT_CC =
{
        .DispatchOffset = offsetof(CFE_TIME_Application_Component_Telecommand_DispatchTable_t, CMD.Sub1HZAdjustmentCmd_indication)
};
...
static const UT_TaskPipeDispatchId_t  UT_TPID_CFE_TIME_CMD_INVALID_LENGTH =
{
        .DispatchOffset = -1,
 ...
 */
struct EdsLib_App_DataTypeDB { uint32 Data; } CFE_TIME_DATATYPE_DB = { 0 };
...
void Test_PipeCmds(void)
{
    ...
    {
            .TopicId = CFE_MISSION_TIME_HK_TLM_TOPICID
    };
    ...
    UT_InitData();
    CFE_SB_InitMsg((CFE_SB_Msg_t *) &CFE_TIME_TaskData.HkPacket, CFE_SB_MsgId_From_TopicId(LocalSnapshotData.TopicId),
    ...
    UT_InitData();
    UT_CallTaskPipe(CFE_TIME_TaskPipe, &CmdBuf.message, sizeof(CmdBuf.cmd), 
            UT_TPID_CFE_TIME_CMD_INVALID_LENGTH);
    UT_Report(__FILE__, __LINE__,
