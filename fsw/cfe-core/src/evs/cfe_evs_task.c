...
#include "cfe_sb.h"           /* Software Bus */
#include "cfe_sb_eds.h"       /* EDS API functions */
...
/* EDS for CFE EVS - content of this file is generated by the build scripts */
...
static const CFE_EVS_Application_Component_Telecommand_DispatchTable_t CFE_EVS_TC_DISPATCH_TABLE =
{
        .CMD =
        {
                .AddEventFilter_indication = CFE_EVS_AddEventFilterCmd,
                .ClearLog_indication = CFE_EVS_ClearLogCmd,
                .DeleteEventFilter_indication = CFE_EVS_DeleteEventFilterCmd,
                .DisableAppEventType_indication = CFE_EVS_DisableAppEventTypeCmd,
                .DisableAppEvents_indication = CFE_EVS_DisableAppEventsCmd,
                .DisableEventType_indication = CFE_EVS_DisableEventTypeCmd,
                .DisablePorts_indication = CFE_EVS_DisablePortsCmd,
                .EnableAppEventType_indication = CFE_EVS_EnableAppEventTypeCmd,
                .EnableAppEvents_indication = CFE_EVS_EnableAppEventsCmd,
                .EnableEventType_indication = CFE_EVS_EnableEventTypeCmd,
                .EnablePorts_indication = CFE_EVS_EnablePortsCmd,
                .WriteAppDataFile_indication = CFE_EVS_WriteAppDataFileCmd,
                .WriteLogDataFile_indication = CFE_EVS_WriteLogDataFileCmd,
                .Noop_indication = CFE_EVS_NoopCmd,
                .ResetAllFilters_indication = CFE_EVS_ResetAllFiltersCmd,
                .ResetAppCounter_indication = CFE_EVS_ResetAppCounterCmd,
                .ResetCounters_indication = CFE_EVS_ResetCountersCmd,
                .ResetFilter_indication = CFE_EVS_ResetFilterCmd,
                .SetEventFormatMode_indication = CFE_EVS_SetEventFormatModeCmd,
                .SetFilter_indication = CFE_EVS_SetFilterCmd,
                .SetLogMode_indication = CFE_EVS_SetLogModeCmd
        },
        .SEND_HK =
        {
...
int32 CFE_EVS_TaskInit ( void )
{
   ...
   CFE_SB_EDS_RegisterSelf(&CFE_EVS_DATATYPE_DB);
...
void CFE_EVS_ProcessCommandPacket ( CFE_SB_MsgPtr_t EVS_MsgPtr )
{
    ...
    Status = CFE_EVS_Application_Component_Telecommand_Dispatch(
    ...
    if (Status == CFE_STATUS_BAD_COMMAND_CODE)
    {
        EVS_SendEvent(CFE_EVS_ERR_CC_EID, CFE_EVS_EventType_ERROR,
            "Invalid command code -- ID = 0x%08x, CC = %d",
             (unsigned int)CFE_SB_MsgIdToValue(CFE_SB_GetMsgId(EVS_MsgPtr)), (int)CFE_SB_GetCmdCode(EVS_MsgPtr));
    }
    else if (Status == CFE_STATUS_WRONG_MSG_LENGTH)
    {
        EVS_SendEvent(CFE_EVS_LEN_ERR_EID, CFE_EVS_EventType_ERROR,
           "Invalid cmd length: ID = 0x%X, CC = %d, Len = %d",
                          ...
                          (int)CFE_SB_GetTotalMsgLength(EVS_MsgPtr));
    }
