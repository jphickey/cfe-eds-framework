...
#ifndef CFE_MISSION_SB_PACKET_TIME_SUBSECONDS_UNITS
    #error CFE_MISSION_SB_PACKET_TIME_SUBSECONDS_UNITS must be defined!
#elif ((CFE_MISSION_SB_PACKET_TIME_SUBSECONDS_UNITS != CFE_MISSION_SB_TIME_SUBSECS_BASE2) && \
       (CFE_MISSION_SB_PACKET_TIME_SUBSECONDS_UNITS != CFE_MISSION_SB_TIME_SUBSECS_MICROSECONDS))
    #error CFE_MISSION_SB_PACKET_TIME_SUBSECONDS_UNITS must be CFE_MISSION_SB_TIME_SUBSECS_BASE2 or CFE_MISSION_SB_TIME_SUBSECS_MICROSECONDS!
#endif
