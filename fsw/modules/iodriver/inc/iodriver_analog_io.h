...
#ifndef IODRIVER_ANALOG_IO_H_
#define IODRIVER_ANALOG_IO_H_
 ...
 */
#define IODRIVER_ADC_BITWIDTH       24


/**
 * Type abstraction for expressing analog ADC codes.
 *
 * This type is an integer type of at least IODRIVER_ADC_BITWIDTH in length.  It is used
 ...
 */
typedef int32 IODriver_AdcCode_t;
...
typedef struct
{
    ...
    IODriver_AdcCode_t *Samples;           ///< Array for ADC/DAC samples
} IODriver_AnalogRdWr_t;
...
enum
{
    IODRIVER_ANALOG_IO_NOOP = IODRIVER_ANALOG_IO_CLASS_BASE,

    IODRIVER_ANALOG_IO_READ_CHANNELS,   /**< IODriver_AnalogRdWr_t argument */
    IODRIVER_ANALOG_IO_WRITE_CHANNELS,  /**< IODriver_AnalogRdWr_t argument */

    IODRIVER_ANALOG_IO_MAX
};


#endif /* IODRIVER_ANALOG_IO_H_ */
