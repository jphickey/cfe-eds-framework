...
int32 SCH_LAB_AppInit(void)
{
    ...
    */
    Status = CFE_TBL_Register(&SCH_LAB_Global.TblHandle, "SCH_LAB_SchTbl", EDS_INDEX(SCH_LAB),
                              SCH_LAB_ScheduleTable_DATADICTIONARY, CFE_TBL_OPT_DEFAULT, NULL);
    ...
    */
    ...
    for (i = 0; i < SCH_LAB_MAX_SCHEDULE_ENTRIES; i++)
    {
        ...
        {
            CFE_SB_InitMsg(&LocalStateEntry->MsgBuf.MsgHdr, CFE_SB_MsgId_From_TopicId(ConfigEntry->TopicID),
